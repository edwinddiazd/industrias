...
<div class="mdl-grid">
    ...
    <div class="mdl-cell mdl-cell--4-col-offset mdl-cell--5-col mdl-shadow--3dp mdl-color--grey-100">
        <div class="mdl-layout-spacer "></div>
            ...
            <div class="mdl-cell mdl-cell--2-col-offset mdl-cell--8-col">
                    <form role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="margin-left: 40px;">
                            ...
                            <label class="mdl-textfield__label" for="password" name="password">Confirme su Password</label>
